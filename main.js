...
const firstCardWidth = carousel.querySelector(".price").offsetWidth;
...
const autoPlay = () => {
    if(window.innerWidth > 1024 || !isAutoPlay) return; // Return if window is smaller than 800 or isAutoPlay is false
